...
export default async function SettingsPage() {
  ...
  const cards = [["organization", "settings.organization"], ["branding", "settings.branding"], ["security", "settings.security"], ["alerts", "settings.alerts"], ["departments", "settings.departments"], ["touchpoints", "settings.touchpoints"], ["rating-scales", "settings.ratingScales"], ["channels", "channels.title"]] as const;
