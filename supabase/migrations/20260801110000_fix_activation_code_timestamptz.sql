-- Fix timestamp type mismatch in regenerate_activation_code
-- The function returns timestamptz but timezone('utc', now()) returns timestamp without time zone
-- This causes: "Returned type timestamp without time zone does not match expected type timestamp with time zone"
